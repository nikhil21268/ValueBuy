...
def upgrade_membership_check():
                ...
                if data is not None:
                        ...
                        mycur.execute("update current_customer set cust_type=%s where c_id=%s",('imperia',c_id))
                        mydb.commit()
                        print("did1")
                        return
                ...
                if data is not None:
                        ...
                        mycur.execute("update current_customer set cust_type=%s where c_id=%s",('premium',c_id))
                        mydb.commit()
                        print("did1")
                        return
